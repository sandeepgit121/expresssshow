		...
		<div class="container">
			<div class="cube">
				...
				<div class="cube__side cube__side--back">
					<div class="screen">
						<div class="video">
							<video class="video-player" src="media/majili.mp4" preload="auto" poster="media/majili.jpg">
								<source src="media/abcd.mp4" type='video/ogg; codecs="theora, vorbis"'>
								<source src="media/jersy.mp4" type='video/mp4; codecs="avc1.4D401E, mp4a.40.2"'>
